var validation = (function(){
	...
	var _clearForm = function  (form) {
		var form = $(this);
		form.find('.input_name, .input-popup, .input-login,.upload-file, .textarea, .textarea-popup').trigger('hideTooltip');
	...
	// инициализация тултипа
	 ...
	 var validateForm = function  (form) {
	 	...
	 	var elements = form.find('input, textarea, .upload-file').not(' input[type="hidden"]'),
	 	valid = true;
